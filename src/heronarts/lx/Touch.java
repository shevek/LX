...
/**
 * Interface for a touch-screen controller. Only supports single-touch.
 * This object is used to access the state of the user's finger.
 */
public interface Touch {
	...
	/**
	 * A dummy helper class for the case where there is no touch-screen
	 * input.
	 */
